...
urlpatterns = patterns('',
    ...
    url(r'^students/register/(?P<id_student>\d+)$','WebSchool.views.register'),
    url(r'^students/edit_register/(?P<id_student>\d+)$','WebSchool.views.edit_register'),
    url(r'^students/unregister/(?P<id_student>\d+)$','WebSchool.views.edit_register'),
